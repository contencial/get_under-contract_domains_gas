...
def write_domain_list(domainList, domainInfo):
    ...
    cell_list = sheet.range('F1:H1')
    cell_list[0].value = 'Size'
    cell_list[1].value = len(domainList)
    cell_list[2].value = '=HYPERLINK("https://muumuu-domain.com/?mode=conpane", "ムームーへGo!!!")'
...
if __name__ == '__main__':
    ...
    login = os.environ["MUU_MUU_LOGIN"]
